    ...
    methods: {
      ...
      async submitLostItemReport() {
        ...
        try {
          ...
          alert("Lost item reported successfully! We'll notify you if we find a match.");
        } catch (error) {
      ...
      async submitFoundItemReport() {
        ...
        try {
          ...
          alert("Found item reported successfully! It will now appear in the search results.");
        } catch (error) {
      ...
      viewClaimDetails(claim) {
        alert(`Claim for ${claim.item.name} is ${claim.status}.`);
      },
